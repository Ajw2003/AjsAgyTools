...
> covers what's specific to C# and Unity.
...
- Before claiming code builds, verify against the real toolchain (`dotnet build` or Unity batch mode),
  never with dummy stub implementations.
